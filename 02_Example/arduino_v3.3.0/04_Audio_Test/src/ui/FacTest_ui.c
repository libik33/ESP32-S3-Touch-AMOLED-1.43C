...
static void setup_scr_screen(lv_factest_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_label_1, 33, 203);
    lv_obj_set_size(ui->screen_label_1, 403, 35);
    lv_label_set_text(ui->screen_label_1, "Start Test");
    lv_label_set_long_mode(ui->screen_label_1, LV_LABEL_LONG_WRAP);

    //Write style for screen_label_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_label_1, lv_color_hex(0x00b6ff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_2, 31, 78);
    lv_obj_set_size(ui->screen_label_2, 403, 30);
    ...
    lv_obj_set_style_text_color(ui->screen_label_2, lv_color_hex(0x00fe54), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_label_2, &lv_font_montserratMedium_30, LV_PART_MAIN|LV_STATE_DEFAULT);
